...
from generation.scenegenerator import SceneGenerator
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="generate_multi_scenes",
    )
    parser.add_argument(
        "--query", help="Query to generate scene from.", default=""
    )
    parser.add_argument(
        "--query_file", help="File to load queries from.", default="/Users/luozhen/Desktop/scenes/output.txt"
    )
    parser.add_argument(
    ...
    parser.add_argument("--openai_api_key", help="OpenAI API key.", default="")
    parser.add_argument(
        "--objaverse_version",
    ...
    parser.add_argument(
        "--save_dir", help="Directory to save scene to.", default="/Users/luozhen/Desktop/scenes/"
    )
    parser.add_argument(
        "--generate_image",
